...
(
	...
	CONSTRAINT [FK_HomeApplianceRepair_AspNetUsers] FOREIGN KEY([ID_User]) REFERENCES [dbo].[AspNetUsers] ([Id]),
	CONSTRAINT [FK_HomeApplianceRepair_AspNetUsersCreatedBy] FOREIGN KEY([ID_User_CreatedBy]) REFERENCES [dbo].[AspNetUsers] ([Id]),
	...
	CONSTRAINT [FK_HomeApplianceRepair_Service] FOREIGN KEY([ID_Service]) REFERENCES [Insurance].[CompanyService] ([ID])
)
