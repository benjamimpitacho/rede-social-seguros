...
(
	...
	CONSTRAINT [FK_MedicalClinic_AspNetUsers] FOREIGN KEY([ID_User]) REFERENCES [dbo].[AspNetUsers] ([Id]),
	CONSTRAINT [FK_MedicalClinic_AspNetUsersCreatedBy] FOREIGN KEY([ID_User_CreatedBy]) REFERENCES [dbo].[AspNetUsers] ([Id]),
